package com.stellarnaus.seabass.support.utils;
...
import com.stellarnaus.seabass.common.constant.SeabassConstant;
...
public class AccountUtils {
    ...
    public <T> T getAccount(Integer sendAccount, String apolloKey, String prefix, Class<T> clazz) {
        String accountValues = config.getProperty(apolloKey, SeabassConstant.APOLLO_DEFAULT_VALUE_JSON_ARRAY);
