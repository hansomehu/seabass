package com.stellarnaus.seabass.handler.flowcontrol.impl;
...
import com.stellarnaus.seabass.handler.enums.RateLimitStrategy;
...
public class FlowControlServiceImpl implements FlowControlService {
    ...
    public void flowControl(TaskInfo taskInfo, FlowControlParam flowControlParam) {
        ...
        Double rateLimitInit = flowControlParam.getRateInitValue();
        ...
        if (rateLimitConfig != null && !rateLimitInit.equals(rateLimitConfig)) {
        ...
        if (RateLimitStrategy.RATE_LIMIT_ON_REQUEST_NUM.equals(flowControlParam.getRateLimitStrategy())) {
            costTime = rateLimiter.acquire(1);
        }
        if (RateLimitStrategy.RATE_LIMIT_ON_SEND_USER_NUM.equals(flowControlParam.getRateLimitStrategy())) {
